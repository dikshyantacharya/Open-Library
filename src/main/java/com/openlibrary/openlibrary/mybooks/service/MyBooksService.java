...
public class MyBooksService {
    ...
    public BookDTO findMyBooksById(long userId,long id) throws Exception {
        Optional<MyBooksEntity> entity = repository.findMyBooksById(id);
        if(entity.isPresent()) {
    ...
    public MyBooksEntity createMyBooks(CreateBookDto createBookDto) {
        ...
        myBookEntity.setBookType(createBookDto.getBookType());
